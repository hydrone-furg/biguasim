...
- ``auv0``: Main :ref:`HoveringAUV <hovering-auv-agent>` agent
    ...
    - :class:`~biguasim.sensors.ImagingSonar` configured with an elevation of 20 degrees, azimuth 130, range 1-40m, an initial octree generation of 40m, and all noise turned on.
