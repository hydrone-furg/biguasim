...
::
    ...
    with biguasim.make("PierHarbor-HoveringImagingSonar", show_viewport=False) as env:
...
========== ==================================================================================================================
Linux      ``~/.local/share/biguasim/{biguasim_version}/worlds/{world_name}/LinuxNoEditor/Holodeck/Octrees``
Windows    ``%USERPROFILE%\AppData\Local\biguasim\{biguasim_version}\worlds\{world_name}\WindowsNoEditor\Holodeck\Octrees``
========== ==================================================================================================================
