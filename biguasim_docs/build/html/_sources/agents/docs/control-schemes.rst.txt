...
Agents in BiguaSim can be controlled using a variety of control schemes. Control schemes determine 
...
The following is a list of control schemes commonly available for BiguaSim agents. 
...
==================================
Control scheme 0 is the default control scheme for most agents in BiguaSim. Most underwater and 
...
==================================
Because BiguaSim uses the Unreal physics engine, most agents move and respond to forces and torques
...
To aid in implementing dynamics, BiguaSim comes with several "sensors" designed to provide ground-truth 
