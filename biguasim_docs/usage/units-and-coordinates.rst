...
BiguaSim uses **meters** for units and a **right-handed coordinate system** for all locations, 
...
Locations and translations in BiguaSim worlds are specified as ``[x, y, z]`` where:
