...
class UavAgent(BiguaSimAgent):
    ...
    **Action Space:**
    ...
    """
    # constants in Uav.h in biguasim-engine
    __MAX_ROLL = 6.5080
...
class FixedWing(BiguaSimAgent):
    ...
    **Instructions for implemeting parameters for Thor Fossen dynamics are given in the corresponding fossen dynamics documentation.**
    ...
    # constants in FixedWing.h in biguasim-engine
    __MAX_LIN_ACCEL = 10
    __MAX_ANG_ACCEL = 2
...
class SphereAgent(BiguaSimAgent):
    ...
    **Action Space:**
    ...
    Inherits from :class:`BiguaSimAgent`.
    """
    # constants in SphereRobot.h in biguasim-engine
    __DISCRETE_MIN = 0
    __DISCRETE_MAX = 4
...
class AndroidAgent(BiguaSimAgent):
    ...
    **Action Space:**
    ...
    Inherits from :class:`BiguaSimAgent`."""
    # constants in Android.h in biguasim-engine
    __MAX_TORQUE = 20
...
class HandAgent(BiguaSimAgent):
    ...
    **Action Space:**
    ...
    """
    # constants in HandAgent.h in biguasim-engine
...
class NavAgent(BiguaSimAgent):
    ...
    # constants in NavAgent.h in biguasim-engine
    __MAX_DISTANCE = 0.5
...
class TurtleAgent(BiguaSimAgent):
    """A simple turtle bot.
    ...
    **Action Space**:
    ...
    Inherits from :class:`BiguaSimAgent`."""
    # constants in TurtleAgent.h in biguasim-engine
    __MAX_THRUST = 160.0
...
class BlueROV2(BiguaSimAgent):
    """BlueROV2 import based on HoveringAUV A simple autonomous underwater vehicle. All variables are not actually used in simulation,
    ...
    **Instructions for implemeting parameters for Thor Fossen dynamics are given in the corresponding fossen dynamics documentation.**
    ...
    :cvar thruster_d: (:obj:`np.ndarray`): 8x3 matrix of unit vectors in the direction of thruster propulsion
    :cvar thruster_p: (:obj:`np.ndarray`): 8x3 matrix of positions in local frame of thrusters positions in m."""
    # constants in HoveringAUV.h in biguasim-engine
    __MAX_LIN_ACCEL = 10
    __MAX_ANG_ACCEL = 2
...
class CougUV(BiguaSimAgent):
    """CougUV is based off the torpedo, a simple foward motion autonomous underwater vehicle. All variables are not actually used in simulation,
    modifying them will have no effect on results. They are exposed for convenience in implementing custom
    dynamics.
    ...
    **Instructions for implemeting parameters for Thor Fossen dynamics are given in the corresponding fossen dynamics documentation.**
    ...
    # constants in DrewUV.h in biguasim-engine
    __MAX_THRUST = 100
    __MAX_FIN = 45
    __MAX_LIN_ACCEL = 10
    __MAX_ANG_ACCEL = 2
...
class ScubaDiver(BiguaSimAgent):
    ...
    **If using the "custom dynamics" control scheme, these values are ignored, and any desired dynamics parameters must be defined separately in your dynamics implementation. **
    ...
    :cvar thruster_d: (:obj:`np.ndarray`): 8x3 matrix of unit vectors in the direction of thruster propulsion
    :cvar thruster_p: (:obj:`np.ndarray`): 8x3 matrix of positions in local frame of thrusters positions in m."""
    # constants in ScubaDiver.h in biguasim-engine
    __MAX_LIN_ACCEL = 10
    __MAX_ANG_ACCEL = 2
...
class HoveringAUV(BiguaSimAgent):
...
class SurfaceVessel(BiguaSimAgent):
    ...
    **If using the "custom dynamics" control scheme, these values are ignored, and any desired dynamics parameters must be defined separately in your dynamics implementation. **
    ...
    # constants in SurfaceVessel.h in biguasim-engine
    __MAX_LIN_ACCEL = 20
    __MAX_ANG_ACCEL = 2
    __MAX_THRUST = 1500
...
class TorpedoAUV(BiguaSimAgent):
    ...
    **Instructions for implemeting parameters for Thor Fossen dynamics are given in the corresponding fossen dynamics documentation.**
    ...
    :cvar thruster_p: (:obj:`np.ndarray`): 3 matrix of positions in local frame of propeller position in m.
    :cvar fin_p: (:obj:`np.ndarray`): 4x3 matrix of positions in local frame of fin positions in m."""
    # constants in TorpedoAUV.h in biguasim-engine
    __MAX_THRUST = 100
    __MAX_FIN = 45
    __MAX_LIN_ACCEL = 10
    __MAX_ANG_ACCEL = 2
