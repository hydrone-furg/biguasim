import numpy as np
from biguasim.dynamics_controls.control import integralSMC
from biguasim.dynamics_controls.gnc import crossFlowDrag, forceLiftDrag, Hmtrx, m2c, gvect, ssa
...
class TAUV:
    ...
    :param dict scenario: scenario dictionary for biguasim 
