...
class WeatherController:
    ...
    def set_fog_density(self, density):
        ...
        if density < 0 or density > 1:
            raise BiguaSimException("Fog density should be between 0 and 1")
    ...
    def start_day_cycle(self, day_length):
        ...
        """
        if day_length <= 0:
            raise BiguaSimException("The given day length should be between above 0!")
    ...
    def set_weather(self, weather_type):
        ...
        if not weather_type in ["rain", "cloudy", "sunny"]:
            raise BiguaSimException("Invalid weather type " + weather_type)
